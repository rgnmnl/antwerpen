...
ui <-  bootstrapPage(
    tags$head(
        ...
        tags$style('#options_panel {position: fixed;}'),
        tags$style('#intro_panel {overflow-y: auto; overflow-x: hidden;}'),
    ...
    absolutePanel(id = "travel_panel",
                  ...
                  style="opacity: 0.8; z-index:400;",
                  class = "panel panel-default",
                  HTML('<button data-toggle="collapse" data-target="#trav">Hide</button>'),
                  fluidRow(
                      column(width = 12, align = "center", h4(strong("Travel Tips and Information"))),
                      tags$div(id = 'trav',  class="collapse",
                               column(width = 12, align = "left",
